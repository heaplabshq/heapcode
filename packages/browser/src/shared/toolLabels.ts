...
const TOOLS: Record<string, ToolLabel> = {
  ...
  fetch_url: { past: 'Fetched a page', present: 'Fetching a page', icon: 'read' },
  web_search: { past: 'Searched the web', present: 'Searching the web', icon: 'find' },
  ...
  double_click: { past: 'Double-clicked', present: 'Double-clicking', icon: 'pointer' },
  triple_click: { past: 'Triple-clicked', present: 'Triple-clicking', icon: 'pointer' },
  right_click: { past: 'Right-clicked', present: 'Right-clicking', icon: 'pointer' },
  ...
  go_forward: { past: 'Went forward', present: 'Going forward', icon: 'back' },
  resize_window: { past: 'Resized the window', present: 'Resizing the window', icon: 'navigate' },
